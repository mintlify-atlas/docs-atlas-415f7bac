...
- [Gateway configuration](/advanced/gateways) - Learn about gateway node deployment
- [Cluster layout management](/operations/cluster-layout) - Understand cluster topology configuration
- [Old design draft](/design/internals) - Historical design documentation
